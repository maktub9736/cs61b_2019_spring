...
//        randomComplexOomage().draw(0.75, 0.25, 1.5);
        ...
        for (int n = 0; n < 1000; n++) {
            ...
            ComplexOomage newOomie = new ComplexOomage(params);
            deadlyList.add(newOomie);
            int num = (newOomie.hashCode() &  0x7FFFFFFF) % 15;
            basketNum[num] += 1;
        }


        for (int m = 0; m < 15; m++) {
            System.out.println(m + " : " + basketNum[m]);
        }
    }
} 
